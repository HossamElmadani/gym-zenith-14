...
// تمت إضافة insuranceEnd لبعض الأعضاء لتجربة الدرع 🛡️
const seed = (): Member[] => [
  { id: "M-1041", name: "Liam Carter",   cin: "AB123456", phone: "+212600111041", gender: "male",   lastCheckIn: tzAddDaysISO(-2),  streak: 4,  points: 480,  plan: "3M",  churnRisk: 12, subStart: tzAddDaysISO(-75),  subEnd: tzAddDaysISO(15),  subMonths: 3,  history: mkHistory("3M", 2),  recentCheckIns: mkCheckIns([2,4,6,9,12]),  createdAt: tzAddDaysISO(-75), insuranceEnd: tzAddDaysISO(200) },
  ...
  { id: "M-1043", name: "Ethan Walsh",   cin: "AB345678", phone: "+212600111043", gender: "male",   lastCheckIn: tzAddDaysISO(-3),  streak: 9,  points: 1240, plan: "12M", churnRisk: 6,  subStart: tzAddDaysISO(-340), subEnd: tzAddDaysISO(25),  subMonths: 12, history: mkHistory("12M", 1), recentCheckIns: mkCheckIns([3,5,7,10,14]),  createdAt: tzAddDaysISO(-340), insuranceEnd: tzAddDaysISO(15) },
  ...
  { id: "M-1045", name: "Daniel Reyes",  cin: "AB567890", phone: "+212600111045", gender: "male",   lastCheckIn: tzAddDaysISO(-1),  streak: 12, points: 1620, plan: "6M",  churnRisk: 3,  subStart: tzAddDaysISO(-150), subEnd: tzAddDaysISO(40),  subMonths: 6,  history: mkHistory("6M", 2),  recentCheckIns: mkCheckIns([1,3,5,8,11]),  createdAt: tzAddDaysISO(-150), insuranceEnd: tzAddDaysISO(210) },
  { id: "F-2031", name: "Ava Mitchell",  cin: "CD123456", phone: "+212600222031", gender: "female", lastCheckIn: tzAddDaysISO(-2),  streak: 6,  points: 760,  plan: "3M",  churnRisk: 10, subStart: tzAddDaysISO(-80),  subEnd: tzAddDaysISO(10),  subMonths: 3,  history: mkHistory("3M", 2),  recentCheckIns: mkCheckIns([2,4,7,10,13]),  createdAt: tzAddDaysISO(-80), insuranceEnd: tzAddDaysISO(250) },
  ...
  { id: "F-2035", name: "Zara Okafor",   cin: "CD567890", phone: "+212600222035", gender: "female", lastCheckIn: tzAddDaysISO(-1),  streak: 14, points: 1890, plan: "12M", churnRisk: 2,  subStart: tzAddDaysISO(-330), subEnd: tzAddDaysISO(35),  subMonths: 12, history: mkHistory("12M", 1), recentCheckIns: mkCheckIns([1,2,4,6,8,11]), createdAt: tzAddDaysISO(-330), insuranceEnd: tzAddDaysISO(35) },
];
